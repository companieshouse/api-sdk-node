    ...
    describe("POST endpoint", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(response.resource).toEqual(mockPscVerificationCreated);
            }
        );
        ...
        it("should return status 400 Bad Request for bad data", async () => {
            ...
            expect(data.httpStatusCode).toBe(StatusCodes.BAD_REQUEST);
            expect(data.errors?.[0]).toBe(ReasonPhrases.BAD_REQUEST);
        });
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(StatusCodes.INTERNAL_SERVER_ERROR);
                expect(data.errors?.[0]).toBe(ReasonPhrases.INTERNAL_SERVER_ERROR);
            }
        );
    });
    ...
    describe("GET endpoint", () => {
        it(
            ...
            async () => {
                ...
                expect(response.resource).toEqual(mockPscVerificationInd);
            }
        );
    ...
    describe("PATCH endpoint", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(response.httpStatusCode).toBe(StatusCodes.OK);
                expect(response.resource).toEqual(mockPscVerificationPatchInd);
            }
        );
    ...
    describe("Validation status GET endpoint", () => {
        it(
            ...
            async () => {
                ...
                expect(response.httpStatusCode).toBe(StatusCodes.OK);
                expect(response.resource).toEqual(mockValidationStatusResponseValid);
                expect(response.resource?.errors).toHaveLength(0);
                expect(response.resource?.isValid).toEqual(true);
            }
        );
    ...
    describe("checkPlannedMaintenance endpoint", () => {
        it(
            ...
            async () => {
                ...
                expect(response.httpStatusCode).toBe(StatusCodes.OK);
                expect(response.resource).toEqual(mockPlannedMaintenanceResource);
            }
        );
