...
describe("OverseasEntityService POST Tests suite", () => {
    ...
    it("should return object Id for postOverseasEntity method", async () => {
        ...
        expect(data.resource?.id).toBe(mockValues.mockOverseasEntityCreatedResource.id);
    });
    ...
    it(
        ...
        async () => {
            ...
            expect(data.errors?.[0]).toBe(mockValues.UNAUTHORISED);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.errors?.[0]).toBe(mockValues.BAD_REQUEST);
        }
    );
});
...
describe("OverseasEntityService GET Tests suite", () => {
    ...
    it(
        ...
        async () => {
            ...
            expect(data.httpStatusCode).toBe(200);
            expect(data.resource).toEqual(mockValues.OVERSEAS_ENTITY_OBJECT_MOCK);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.httpStatusCode).toBe(400);
            expect(data.errors![0]).toEqual(mockValues.BAD_REQUEST);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.httpStatusCode).toBe(200);
            expect(data.resource).toEqual(mockValues.OVERSEAS_ENTITY_EXTRA_DETAILS_OBJECT_MOCK);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.httpStatusCode).toBe(200);
            expect(data.resource).toEqual(mockValues.BENEFICIAL_OWNER_PRIVATE_DATA_RESOURCE_MOCK);
        }
    );
...
describe("Mapping OverseasEntity Tests suite", () => {
    it(
        "should return OverseasEntityResource object from mapOverseasEntity method",
        async () => {
            ...
            expect(data.entity_name).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.entity_name);
            expect(data.entity_number).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.entity_number);
            expect(data.presenter).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.presenter);
            expect(data.entity).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.entity);
            expect(data.due_diligence).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.due_diligence);
            expect(data.overseas_entity_due_diligence).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.overseas_entity_due_diligence
            );
            expect(data.beneficial_owners_statement).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.beneficial_owners_statement
            );
            expect(data.beneficial_owners_individual?.[0]).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.beneficial_owners_individual?.[0]
            );
            expect(data.beneficial_owners_corporate?.[0]).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.beneficial_owners_corporate?.[0]
            );
            expect(data.beneficial_owners_government_or_public_authority?.[0]).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.beneficial_owners_government_or_public_authority?.[0]
            );
            expect(data.managing_officers_individual?.[0]).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.managing_officers_individual?.[0]
            );
            expect(data.managing_officers_corporate?.[0]).toEqual(
                mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.managing_officers_corporate?.[0]
            );
            expect(data.trusts?.[0]).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.trusts?.[0]);
            expect(data.update).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.update);
            expect(data.is_remove).toEqual(true);
            expect(data.has_sold_land).toEqual(false);
            expect(data.is_secure_register).toEqual(false);
            expect(data.who_is_registering).toEqual(ENTITY_WHO_IS_REGISTERING.AGENT);
            expect(data.remove).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.remove);
            expect(data.payment).toEqual(mockValues.PAYMENT_OBJECT_MOCK);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.update).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.update);
            expect(data.is_remove).toEqual(true);
            expect(data.has_sold_land).toEqual(true);
            expect(data.is_secure_register).toEqual(true);
            expect(data.who_is_registering).toEqual(ENTITY_WHO_IS_REGISTERING.SOMEONE_ELSE);
            expect(data.remove).toEqual(mockValues.OVERSEAS_ENTITY_RESOURCE_OBJECT_MOCK.remove);
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with all empty sub fields",
        async () => {
            const data = mapOverseasEntity({
            ...
            expect(data.entity_name).toEqual(null);
            expect(data.entity_number).toEqual(null);
            expect(data.presenter).toEqual(null);
            expect(data.entity).toEqual(null);
            expect(data.due_diligence).toEqual(null);
            expect(data.overseas_entity_due_diligence).toEqual(null);
            expect(data.beneficial_owners_statement).toBeUndefined();
            expect(data.beneficial_owners_individual).toEqual([]);
            expect(data.beneficial_owners_corporate).toEqual([]);
            expect(data.beneficial_owners_government_or_public_authority).toEqual([]);
            expect(data.managing_officers_individual).toEqual([]);
            expect(data.managing_officers_corporate).toEqual([]);
            expect(data.trusts).toEqual([]);
            expect(data.update).toEqual({});
            expect(data.remove).toEqual({});
            expect(data.is_remove).toEqual(null);
            expect(data.has_sold_land).toBeUndefined();
            expect(data.is_secure_register).toBeUndefined();
            expect(data.who_is_registering).toBeUndefined();
            expect(data.payment).toEqual(null);
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method",
        async () => {
            ...
            expect(data.entity_name).toEqual(mockValues.ENTITY_NAME_FIELD_MOCK);
            expect(data.entity_number).toEqual(mockValues.ENTITY_NUMBER_MOCK);
            expect(data.presenter).toEqual(mockValues.PRESENTER_OBJECT_MOCK);
            expect(data.entity).toEqual(mockValues.ENTITY_OBJECT_MOCK);
            expect(data.due_diligence).toEqual(mockValues.DUE_DILIGENCE_MOCK);
            expect(data.overseas_entity_due_diligence).toEqual(mockValues.OE_DUE_DILIGENCE_MOCK);
            expect(data.beneficial_owners_statement).toEqual(BeneficialOwnersStatementType.ALL_IDENTIFIED_ALL_DETAILS);
            expect(data.beneficial_owners_individual).toEqual(mockValues.BENEFICIAL_OWNER_INDIVIDUAL_MOCK_LIST);
            expect(data.beneficial_owners_corporate).toEqual(mockValues.BENEFICIAL_OWNER_CORPORATE_MOCK_LIST);
            expect(data.beneficial_owners_government_or_public_authority).toEqual(mockValues.BENEFICIAL_OWNER_GOVERNMENT_MOCK_LIST);
            expect(data.managing_officers_individual).toEqual(mockValues.MANAGING_OFFICERS_INDIVIDUAL_MOCK_LIST);
            expect(data.managing_officers_corporate).toEqual(mockValues.MANAGING_OFFICERS_CORPORATE_MOCK_LIST);
            expect(data.trusts).toEqual(mockValues.TRUSTS_MOCK);
            expect(data.trusts).toEqual(mockValues.TRUSTS_MOCK);
            expect(data.update).toEqual(mockValues.UPDATE_OBJECT_MOCK);
            expect(data.remove).toEqual(mockValues.REMOVE_OBJECT_MOCK);
            expect(data.is_remove).toEqual(true);
            expect(data.has_sold_land).toEqual("1");
            expect(data.is_secure_register).toEqual("1");
            expect(data.who_is_registering).toEqual("agent");
            expect(data.payment).toEqual(mockValues.PAYMENT_OBJECT_MOCK);
        }
    );
    ...
    it(
        ...
        async () => {
            ...
            expect(data.remove).toEqual(mockValues.REMOVE_OBJECT_MOCK);
            expect(data.is_remove).toEqual(true);
            expect(data.has_sold_land).toEqual("0");
            expect(data.is_secure_register).toEqual("0");
            expect(data.who_is_registering).toEqual("someone_else");
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with just EntityName data",
        async () => {
            const data = mapOverseasEntityResource({
            ...
            expect(data.entity_name).toEqual(mockValues.ENTITY_NAME_FIELD_MOCK);
            expect(data.entity_number).toBeUndefined();
            expect(data.presenter).toEqual({});
            expect(data.entity).toEqual({});
            expect(data.due_diligence).toEqual({});
            expect(data.overseas_entity_due_diligence).toEqual({});
            expect(data.beneficial_owners_statement).toBeUndefined();
            expect(data.beneficial_owners_individual).toEqual([]);
            expect(data.beneficial_owners_corporate).toEqual([]);
            ...
            expect(data.managing_officers_corporate).toEqual([]);
            expect(data.trusts).toEqual([]);
            expect(data.is_remove).toBeUndefined();
            expect(data.has_sold_land).toBeUndefined();
            expect(data.is_secure_register).toBeUndefined();
            expect(data.payment).toEqual(null);
        }
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with just entity number data",
        async () => {
            const data = mapOverseasEntityResource({
                entity_name: undefined,
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with just Presenter data",
        async () => {
            const data = mapOverseasEntityResource({
                entity_name: undefined,
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with just Update data",
        async () => {
            const data = mapOverseasEntityResource({
                entity_name: undefined,
                presenter: undefined,
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with just Remove data",
        async () => {
            const data = mapOverseasEntityResource({
                entity_name: undefined,
                presenter: undefined,
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with mapped Update dates",
        async () => {
            const data = mapOverseasEntityResource({
                entity_name: undefined,
                presenter: undefined,
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with no Update filing date",
        async () => {
            ...
            expect(data.update?.filing_date).toBeUndefined();
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with no date of creation",
        async () => {
            const updateResource = {
                ...mockValues.UPDATE_RESOURCE_MOCK
            };
            ...
            expect(data.update?.date_of_creation).toBeUndefined();
        }
    );

    it(
        "should return OE Due Diligence object with identity_date as InputDate object if identity date is null",
        () => {
            ...
            expect(dataResource.overseas_entity_due_diligence?.identity_date).toEqual({ day: "", month: "", year: "" });
        }
    );

    it(
        "should return OE Due Diligence object without identity_date field if identity date is undefined",
        () => {
            ...
            expect(Object.keys(dataResource.overseas_entity_due_diligence!).indexOf("identity_date")).toBe(-1);
        }
    );

    it(
        "should return OE Due Diligence object without identity_date field if identity date subfields are empty",
        () => {
            const dataResource = mapOverseasEntity({
                overseas_entity_due_diligence: {
                    ...mockValues.OE_DUE_DILIGENCE_MOCK,
    ...
    it("should return OE extra details object with email address", () => {
        ...
        expect(dataResource.email_address).toBe("private@overseasentities.test");
    });

    it(
        "should return OE extra details object without email address if empty",
        () => {
            const dataResource = mapOverseasEntityExtraDetails({} as OverseasEntityExtraDetails);

            expect(dataResource.email_address).toBeUndefined();
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with no review trust ceased date",
        async () => {
            const updateResource = {
                ...mockValues.UPDATE_RESOURCE_MOCK
            };
            ...
            expect(overseasEntity.update?.review_trusts?.[0].ceased_date_day).toBeUndefined();
            expect(overseasEntity.update?.review_trusts?.[0].ceased_date_month).toBeUndefined();
            expect(overseasEntity.update?.review_trusts?.[0].ceased_date_year).toBeUndefined();
            expect(overseasEntity.update?.review_trusts?.[0].trust_id).toBe("1234");
            expect(overseasEntity.update?.review_trusts?.[0].ch_reference).toBe("_ecba-4TzUTXaln-g8daGtvS4a0");
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with no review trust ceased date",
        async () => {
            const update = {
            ...
            expect(overseasEntityResource.update?.review_trusts?.[0].ceased_date).toBe("");
            expect(overseasEntityResource.update?.review_trusts?.[0].trust_id).toBe("1234");
            expect(overseasEntityResource.update?.review_trusts?.[0].ch_reference).toBe("_ecba-4TzUTXaln-g8daGtvS4a0");
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with Trust data but no ceased date",
        async () => {
            ...
            expect(overseasEntityResource.trusts?.[0].ceased_date).toBe("");
            expect(overseasEntityResource.trusts?.[0].trust_id).toBe("123");
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with Trust data but no ceased date",
        async () => {
            ...
            expect(overseasEntity.trusts?.[0].ceased_date_day).toBeUndefined();
            expect(overseasEntity.trusts?.[0].ceased_date_month).toBeUndefined();
            expect(overseasEntity.trusts?.[0].ceased_date_year).toBeUndefined();
            expect(overseasEntity.trusts?.[0].trust_id).toBe("123");
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with Trust data but with 'still involved' flag set to null",
        async () => {
            const overseasEntity = {
                trusts: mockValues.TRUSTS_MOCK
            };
            ...
            expect(overseasEntityResource.trusts?.[0].trust_still_involved_in_overseas_entity).toBe(null);
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with Trust data but with 'still involved' flag set to null",
        async () => {
            const overseasEntityResource: OverseasEntityResource = {
                trusts: mockValues.TRUSTS_RESOURCE_MOCK
            };
            ...
            expect(overseasEntity.trusts?.[0].trust_still_involved_in_overseas_entity).toBe(null);
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with Trust data but with 'still involved' flag mapped from undefined to null",
        async () => {
            const overseasEntity = {
                trusts: mockValues.TRUSTS_MOCK
            };
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with Trust data but with 'still involved' flag mapped from undefined to null",
        async () => {
            const overseasEntityResource: OverseasEntityResource = {
                trusts: mockValues.TRUSTS_RESOURCE_MOCK
            };
    ...
    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with Trust Individual data but with 'is_individual_still_involved_in_trust' flag set to null",
        async () => {
            const overseasEntity = {
                trusts: mockValues.TRUSTS_MOCK,
                update: mockValues.UPDATE_OBJECT_MOCK
            ...
            expect(overseasEntityResource.trusts?.[0].INDIVIDUAL?.[0].is_individual_still_involved_in_trust).toBe(null);
            expect(overseasEntityResource.update?.review_trusts?.[0].INDIVIDUAL?.[0].is_individual_still_involved_in_trust).toBe(null);
        }
    );

    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with Trust Individual data but with 'still involved' flag set to null",
        async () => {
            const overseasEntityResource: OverseasEntityResource = {
                trusts: mockValues.TRUSTS_RESOURCE_MOCK,
                update: mockValues.UPDATE_RESOURCE_MOCK
            ...
            expect(overseasEntity.trusts?.[0].INDIVIDUALS?.[0].still_involved).toBe(null);
            expect(overseasEntity.update?.review_trusts?.[0].INDIVIDUALS?.[0].still_involved).toBe(null);
        }
    );

    it(
        "should return OverseasEntityResource object from mapOverseasEntity method with Trust Individual data but with 'is_individual_still_involved_in_trust' flag mapped from undefined to null",
        async () => {
            const overseasEntity = {
                trusts: mockValues.TRUSTS_MOCK,
                update: mockValues.UPDATE_OBJECT_MOCK
    ...
    it(
        "should return OverseasEntity object from mapOverseasEntityResource method with Trust Individual data but with 'still involved' flag mapped from undefined to null",
        async () => {
            const overseasEntityResource: OverseasEntityResource = {
                trusts: mockValues.TRUSTS_RESOURCE_MOCK,
                update: mockValues.UPDATE_RESOURCE_MOCK
    ...
    describe("OverseasEntityService getManagingOfficersPrivateData Tests suite", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.MANAGING_OFFICERS_PRIVATE_DATA_MOCK);
            }
        );
    ...
    describe("OverseasEntityService getTrustsPrivateData Tests suite", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.PRIVATE_TRUSTS_DATA_MOCK);
            }
        );
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.PRIVATE_TRUSTS_NOT_CEASED_DATA_MOCK);
            }
        );
    ...
    describe("OverseasEntityService getTrustLinksPrivateData Tests suite", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.TRUST_LINKS_MOCK);
            }
        );
    ...
    describe("OverseasEntityService getIndividualTrusteesPrivateData Tests suite", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.INDIVIDUAL_TRUSTEES_DATA_MOCK);
            }
        );
    ...
    describe("OverseasEntityService getCorporateTrusteesPrivateData Tests suite", () => {
        ...
        it(
            ...
            async () => {
                ...
                expect(data.httpStatusCode).toBe(200);
                expect(data.resource).toEqual(mockValues.CORPORATE_TRUSTEES_DATA_MOCK);
            }
        );

        it(
            "should return OverseasEntityResource object from mapOverseasEntity method with trust corporate still involved flag set to null",
            async () => {
                const overseasEntity = {
                    trusts: mockValues.TRUSTS_MOCK
                }
                ...
                expect(overseasEntityResource.trusts?.[0].CORPORATE?.[0].is_corporate_still_involved_in_trust).toBe(null);
            }
        );

        it(
            "should return OverseasEntity object from mapOverseasEntityResource method with trust corporate still involved flag set to null",
            async () => {
                ...
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].still_involved).toBe(null);
            }
        );

        it(
            "should return OverseasEntityResource object from mapOverseasEntity method with trust corporate still involved flag set to true",
            async () => {
                const overseasEntity = {
                    trusts: mockValues.TRUSTS_MOCK
                }
                ...
                const overseasEntityResource = mapOverseasEntity(overseasEntity);
                expect(overseasEntityResource.trusts?.[0].CORPORATE?.[0].is_corporate_still_involved_in_trust).toBe(true);
            }
        );

        it(
            "should return OverseasEntity object from mapOverseasEntityResource method with trust corporate still involved flag set to yes",
            async () => {
                const overseasEntityResource = {
                    trusts: mockValues.TRUSTS_RESOURCE_MOCK
                }
                ...
                const overseasEntity = mapOverseasEntityResource(overseasEntityResource);
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].still_involved).toBe("Yes");
            }
        );

        it(
            "should return OverseasEntityResource object from mapOverseasEntity method with trust corporate still involved flag set to false",
            async () => {
                const overseasEntity = {
                    trusts: mockValues.TRUSTS_MOCK
                }
                ...
                const overseasEntityResource = mapOverseasEntity(overseasEntity);
                expect(overseasEntityResource.trusts?.[0].CORPORATE?.[0].is_corporate_still_involved_in_trust).toBe(false);
                expect(overseasEntityResource.trusts?.[0].CORPORATE?.[0].ceased_date).toBe("2005-09-01");
            }
        );

        it(
            "should return OverseasEntity object from mapOverseasEntityResource method with trust corporate still involved flag set to no",
            async () => {
                const overseasEntityResource = {
                    trusts: mockValues.TRUSTS_RESOURCE_MOCK
                }
                ...
                const overseasEntity = mapOverseasEntityResource(overseasEntityResource);
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].still_involved).toBe("No");
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].ceased_date_day).toBe("1");
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].ceased_date_month).toBe("9");
                expect(overseasEntity.trusts?.[0].CORPORATES?.[0].ceased_date_year).toBe("2005");
            }
        );
        ...
        it(
            "should pass camel case though but convert snake case for trust retrieval",
            () => {
                const response = [
                    {
                        hashedTrusteeId: "123",
