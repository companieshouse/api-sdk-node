...
describe("CheckoutItemService", () => {
    describe("getCheckoutItem", () => {
        it("Maps missing image delivery item to object containing camel case keys", async () => {
            ...
            // when
            const actual = await checkoutItemService.getCheckoutItem("ORD-123123-123123", "MID-123123-123123") as Success<Item, CheckoutItemErrorResponse>;
        ...
        it("Maps certified copy item to object containing camel case keys", async () => {
            ...
            // when
            const actual = await checkoutItemService.getCheckoutItem("ORD-123123-123123", "CCD-123456-123456") as Success<Item, CheckoutItemErrorResponse>;
        ...
        it("Returns failure with response code attached if error occurs", async () => {
            ...
            // when
            const actual = await checkoutItemService.getCheckoutItem("ORD-123123-123123", "CCD-123456-123456") as Failure<Item, CheckoutItemErrorResponse>;
