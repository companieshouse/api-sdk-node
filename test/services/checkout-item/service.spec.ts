...
describe("CheckoutItemService", () => {
    describe("getCheckoutItem", () => {
        it(
            "Maps missing image delivery item to object containing camel case keys",
            async () => {
                // given
        ...
        it(
            "Maps certified copy item to object containing camel case keys",
            async () => {
                // given
                const serverResponse = {
                    status: 200,
        ...
        it(
            "Returns failure with response code attached if error occurs",
            async () => {
                // given
                const serverResponse = {
                    status: 401,
        ...
        it(
            "Returns failure with response code attached if items is undefined",
            async () => {
                // given
                const serverResponse = {
                    status: 200,
                ...
                expect(actual.isFailure()).toBe(true);
                expect(actual.value.httpStatusCode).toBe(200);
                expect(actual.value.error).toBe("Expected checkout returned by api to have exactly one embedded item.");
            }
        );
