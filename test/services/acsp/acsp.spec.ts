...
describe("Acsp Registration GET", () => {
    it("should return an Acsp registration", async () => {
        jest.spyOn(mockValues.requestClient, "httpGet").mockClear().mockResolvedValue(mockValues.mockGetAcsp[200]);
    ...
    it("should return error 404 - Not found", async () => {
        jest.spyOn(mockValues.requestClient, "httpGet").mockClear().mockResolvedValue(mockValues.mockGetAcsp[404]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
    ...
    it("should return error 500 - Internal server error", async () => {
        jest.spyOn(mockValues.requestClient, "httpGet").mockClear().mockResolvedValue(mockValues.mockGetAcsp[500]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
        const data: ApiErrorResponse = await ofService.getAcsp(TRANSACTION_ID, SUBMISSION_ID);
...
describe("Acsp Registration POST", () => {
    it("should return an Acsp registration", async () => {
        jest.spyOn(mockValues.requestClient, "httpPost").mockClear().mockResolvedValue(mockValues.mockPostAcsp[200]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
    ...
    it("should return error 409 - Document already exists", async () => {
        jest.spyOn(mockValues.requestClient, "httpPost").mockClear().mockResolvedValue(mockValues.mockPostAcsp[409]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
...
describe("Acsp Registration PUT", () => {
    it("should return an Acsp registration", async () => {
        jest.spyOn(mockValues.requestClient, "httpPut").mockClear().mockResolvedValue(mockValues.mockPutAcsp[200]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
    ...
    it("should return error 404 - Not found", async () => {
        jest.spyOn(mockValues.requestClient, "httpPut").mockClear().mockResolvedValue(mockValues.mockPutAcsp[404]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
...
describe("Acsp Registration DELETE", () => {
    it("should return 204 on successful delete", async () => {
        jest.spyOn(mockValues.requestClient, "httpDelete").mockClear().mockResolvedValue(mockValues.mockDeleteAcsp[204]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
    ...
    it("should return 404 if no application exists", async () => {
        jest.spyOn(mockValues.requestClient, "httpDelete").mockClear().mockResolvedValue(mockValues.mockDeleteAcsp[404]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
        const data = await ofService.deleteSavedApplication(TRANSACTION_ID, SUBMISSION_ID);
...
describe("ACSP Verifiy a client send confirmation email", () => {
    it("should return 200 on successful email send", async () => {
        jest.spyOn(mockValues.requestClient, "httpPost").mockClear().mockResolvedValue(mockValues.mockSendEmail[200]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
    ...
    it("should return 500 if email fails", async () => {
        jest.spyOn(mockValues.requestClient, "httpPost").mockClear().mockResolvedValue(mockValues.mockSendEmail[500]);
        const ofService: AcspService = new AcspService(mockValues.requestClient);
        const data = await ofService.sendIdentityVerificationEmail(mockValues.mockClientVerificationEmail);
