...
const service_20 = __importDefault(require("./services/psc-extensions-link/service"));
const accounts_filing_1 = require("./services/accounts-filing");
const service_21 = __importDefault(require("./services/psc/service"));
const limited_partnerships_1 = require("./services/limited-partnerships");
const service_22 = __importDefault(require("./services/associations/service"));
const sic_code_1 = require("./services/sic-code");
/**
...
class ApiClient {
    constructor(apiClient, accountClient) {
        ...
        this.pscExtensionsService = new service_20.default(apiClient);
        ...
        this.pscService = new service_21.default(apiClient);
        this.limitedPartnershipsService = new limited_partnerships_1.LimitedPartnershipsService(apiClient);
        this.associationsService = new service_22.default(accountClient);
        this.sicCodeService = new sic_code_1.CondensedSicCodeService(apiClient);
    }
}
