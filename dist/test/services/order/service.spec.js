...
const service_1 = __importDefault(require("../../../src/services/order/order/service"));
...
const mockCertificateOrderResponseBody = {
...
const mockCertifiedCopyOrderResponseBody = {
...
const mockMissingImageDeliveryOrderResponseBody = {
...
describe("order", () => {
    describe("get an order", () => {
        ...
        it("returns an error response on failure", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            sinon_1.default.mock(requestClient)
                .expects("httpGet")
                .once()
                .withArgs("/orders/ORD-123456-123456")
                .returns(mockGetResponse);
            const order = new service_1.default(requestClient);
            const actual = yield order.getOrder(CERTIFICATE_ORDER_ID);
        ...
        it("should map generic fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockGetResponse = {
                status: 200,
            ...
            const order = new service_1.default(requestClient);
            const response = yield order.getOrder(CERTIFICATE_ORDER_ID);
        ...
        it("should map certificate item option fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockGetResponse = {
                status: 200,
                body: mockCertificateOrderResponseBody
            };
            ...
            const item = data.items[0];
            const itemResource = mockCertificateOrderResponseBody.items[0];
            const itemOptionsResource = itemResource.item_options;
        ...
        it("should map certified copy item option fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockGetResponse = {
                status: 200,
            ...
            sinon_1.default.stub(requestClient, "httpGet").resolves(mockGetResponse);
            const order = new service_1.default(requestClient);
            const response = yield order.getOrder(CERTIFIED_COPY_ORDER_ID);
            const data = response.value;
            const item = data.items[0];
        ...
        it("should map missing image delivery item option fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockGetResponse = {
                status: 200,
            ...
            sinon_1.default.stub(requestClient, "httpGet").resolves(mockGetResponse);
            const order = new service_1.default(requestClient);
            const response = yield order.getOrder(MISSING_IMAGE_DELIVERY_ORDER_ID);
            const data = response.value;
            const item = data.items[0];
