...
const service_1 = __importDefault(require("../../../src/services/order/checkout/service"));
...
const mockCertificateCheckoutResponseBody = {
...
const mockCertifiedCopyCheckoutResponseBody = {
    status: "paid",
...
const mockMissingImageDeliveryCheckoutResponseBody = {
    status: "paid",
...
describe("checkout", () => {
    describe("get a checkout", () => {
        ...
        it("returns an error response on failure", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const checkout = new service_1.default(requestClient);
            const result = yield checkout.getCheckout(CERTIFICATE_CHECKOUT_ID);
        ...
        it("should map certified copy item option fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            sinon_1.default.stub(requestClient, "httpGet").resolves(mockGetResponse);
            const checkout = new service_1.default(requestClient);
            const response = yield checkout.getCheckout(CERTIFIED_COPY_CHECKOUT_ID);
            const data = response.value.resource;
            const item = data.items[0];
        ...
        it("should map missing image delivery item option fields correctly", () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            sinon_1.default.stub(requestClient, "httpGet").resolves(mockGetResponse);
            const checkout = new service_1.default(requestClient);
            const result = yield checkout.getCheckout(MISSING_IMAGE_DELIVERY_CHECKOUT_ID);
            const data = result.value.resource;
            const item = data.items[0];
