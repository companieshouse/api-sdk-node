...
class default_1 {
    ...
    mapToConfirmationStatementSubmissionData(dataResource) {
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ confirmationStatementMadeUpToDate: dataResource.confirmation_statement_made_up_to_date }, (dataResource.persons_significant_control_data && { personsSignificantControlData: this.mapToPersonsOfSignificantControlData(dataResource.persons_significant_control_data) })), (dataResource.statement_of_capital_data && { statementOfCapitalData: this.mapToStatementOfCapitalData(dataResource.statement_of_capital_data) })), (dataResource.sic_code_data && { sicCodeData: this.mapToSicCodeData(dataResource.sic_code_data) })), (dataResource.registered_office_address_data && { registeredOfficeAddressData: this.mapToRegisteredOfficeAddressData(dataResource.registered_office_address_data) })), (dataResource.registered_email_address_data && { registeredEmailAddressData: this.mapToRegisteredEmailAddressData(dataResource.registered_email_address_data) })), (dataResource.active_officer_details_data && { activeOfficerDetailsData: this.mapToActiveOfficerDetailsData(dataResource.active_officer_details_data) })), (dataResource.shareholder_data && { shareholderData: this.mapToShareholderData(dataResource.shareholder_data) })), (dataResource.register_locations_data && { registerLocationsData: this.mapToRegisterLocationsData(dataResource.register_locations_data) })), (dataResource.trading_status_data && { tradingStatusData: this.mapToTradingStatusData(dataResource.trading_status_data) })), (dataResource.new_confirmation_date && { newConfirmationDate: dataResource.new_confirmation_date })), { acceptLawfulPurposeStatement: dataResource.accept_lawful_purpose_statement });
    }
    mapToConfirmationStatementSubmissionDataResource(data) {
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ confirmation_statement_made_up_to_date: data.confirmationStatementMadeUpToDate }, (data.personsSignificantControlData && { persons_significant_control_data: this.mapToPersonsOfSignificantControlDataResource(data.personsSignificantControlData) })), (data.statementOfCapitalData && { statement_of_capital_data: this.mapToStatementOfCapitalDataResource(data.statementOfCapitalData) })), (data.sicCodeData && { sic_code_data: this.mapToSicCodeDataResource(data.sicCodeData) })), (data.registeredOfficeAddressData && { registered_office_address_data: this.mapToRegisteredOfficeAddressDataResource(data.registeredOfficeAddressData) })), (data.registeredEmailAddressData && { registered_email_address_data: this.mapToRegisteredEmailAddressDataResource(data.registeredEmailAddressData) })), (data.activeOfficerDetailsData && { active_officer_details_data: this.mapToActiveOfficerDetailsDataResource(data.activeOfficerDetailsData) })), (data.shareholderData && { shareholder_data: this.mapToShareholderDataResource(data.shareholderData) })), (data.registerLocationsData && { register_locations_data: this.mapToRegisterLocationsDataResource(data.registerLocationsData) })), (data.tradingStatusData && { trading_status_data: this.mapToTradingStatusDataResource(data.tradingStatusData) })), (data.newConfirmationDate && { new_confirmation_date: data.newConfirmationDate })), { accept_lawful_purpose_statement: data.acceptLawfulPurposeStatement });
    }
    ...
    mapToSicCodeDataResource(sicCode) {
        return Object.assign({ section_status: sicCode.sectionStatus }, (sicCode.sicCode && { sic_code: sicCode.sicCode.map(this.mapToSicCodeResource) }));
    }
    mapToSicCodeData(sicCodeResource) {
        return Object.assign({ sectionStatus: sicCodeResource.section_status }, (sicCodeResource.sic_code && { sicCode: sicCodeResource.sic_code.map(this.mapToSicCode) }));
    }
    ...
    mapToRegisteredEmailAddressDataResource(registeredEmailAddress) {
        return {
    ...
    mapToRegisteredEmailAddressData(registeredEmailAddressResource) {
        return {
