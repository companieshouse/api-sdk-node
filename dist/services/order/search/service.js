...
exports.CheckoutSearchService = void 0;
const result_1 = require("../../result");
const mapping_1 = __importDefault(require("../../../mapping/mapping"));
class CheckoutSearchService {
    constructor(client) {
        this.client = client;
    }
    search(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const serverResponse = yield this.client.httpGet("/checkouts/search" + (queryParams ? ("?" + queryParams) : ""));
            const response = {
...
exports.CheckoutSearchService = CheckoutSearchService;
