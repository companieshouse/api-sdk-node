...
class default_1 {
    ...
    getMid(missingImageDeliveryId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            resource.resource = mapping_1.default.mapMidItemResourceToMidItem(body);
            return resource;
        });
    }
    ;
    postMid(midItemRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            const midItemRequestResource = mapping_1.default.mapMidItemRequestToMidItemRequestResource(midItemRequest);
