...
class default_1 {
     ...
     */
    deleteSavedApplication(transactionId, acspApplicationId) {
        return __awaiter(this, void 0, void 0, function* () {
            const url = `/transactions/${transactionId}/authorised-corporate-service-provider-applications/${acspApplicationId}`;
     ...
     */
    sendIdentityVerificationEmail(emailData, queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            let url = `/acsp-api/verify-client-identity/send-identity-verification-email`;
            if (queryParams === null || queryParams === void 0 ? void 0 : queryParams.application_type) {
