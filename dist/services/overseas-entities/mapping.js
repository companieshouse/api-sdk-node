...
const mapToTrust = (trust) => {
    ...
    return {
        ...
        CORPORATES: (trust.CORPORATE || []).map(trustCorp => {
            const { date_became_interested_person, is_corporate_still_involved_in_trust, ceased_date } = trustCorp, rest = __rest(trustCorp, ["date_became_interested_person", "is_corporate_still_involved_in_trust", "ceased_date"]);
            const dbipDate = mapIsoDate(date_became_interested_person);
