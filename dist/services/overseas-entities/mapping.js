...
const mapTrust = (trust) => {
    const { creation_date_day, creation_date_month, creation_date_year, ceased_date_day, ceased_date_month, ceased_date_year, INDIVIDUALS, HISTORICAL_BO, CORPORATES, unable_to_obtain_all_trust_info } = trust, rest = __rest(trust, ["creation_date_day", "creation_date_month", "creation_date_year", "ceased_date_day", "ceased_date_month", "ceased_date_year", "INDIVIDUALS", "HISTORICAL_BO", "CORPORATES", "unable_to_obtain_all_trust_info"]);
