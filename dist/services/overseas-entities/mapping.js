...
*/
const mapTrustsToReviewResource = (trusts = []) => {
    return (trusts || []).map(trust => mapToTrustToReview(trust));
};
const mapToTrust = (trust) => {
    ...
    return {
        ...
        ceased_date_day: ceased_date === null || ceased_date === void 0 ? void 0 : ceased_date.day,
        ceased_date_month: ceased_date === null || ceased_date === void 0 ? void 0 : ceased_date.month,
        ceased_date_year: ceased_date === null || ceased_date === void 0 ? void 0 : ceased_date.year,
        ...
        INDIVIDUALS: (trust.INDIVIDUAL || []).map(trustInd => {
            const { date_of_birth, date_became_interested_person, ceased_date: individual_ceased_date, is_individual_still_involved_in_trust, start_date } = trustInd, rest = __rest(trustInd, ["date_of_birth", "date_became_interested_person", "ceased_date", "is_individual_still_involved_in_trust", "start_date"]);
            ...
            return Object.assign(Object.assign({}, rest), { dob_day: dobDate.day, dob_month: dobDate.month, dob_year: dobDate.year, date_became_interested_person_day: dbipDate.day, date_became_interested_person_month: dbipDate.month, date_became_interested_person_year: dbipDate.year, still_involved: isIndividualStillInvolvedInTrust, ceased_date_day: individualCeasedDate === null || individualCeasedDate === void 0 ? void 0 : individualCeasedDate.day, ceased_date_month: individualCeasedDate === null || individualCeasedDate === void 0 ? void 0 : individualCeasedDate.month, ceased_date_year: individualCeasedDate === null || individualCeasedDate === void 0 ? void 0 : individualCeasedDate.year, start_date_day: startDate === null || startDate === void 0 ? void 0 : startDate.day, start_date_month: startDate === null || startDate === void 0 ? void 0 : startDate.month, start_date_year: startDate === null || startDate === void 0 ? void 0 : startDate.year });
        }),
        ...
        CORPORATES: (trust.CORPORATE || []).map(trustCorp => {
            const { date_became_interested_person, is_corporate_still_involved_in_trust, ceased_date, start_date } = trustCorp, rest = __rest(trustCorp, ["date_became_interested_person", "is_corporate_still_involved_in_trust", "ceased_date", "start_date"]);
            const dbipDate = mapIsoDate(date_became_interested_person);
            ...
            return Object.assign(Object.assign({}, rest), { date_became_interested_person_day: dbipDate.day, date_became_interested_person_month: dbipDate.month, date_became_interested_person_year: dbipDate.year, still_involved: isInvolved, ceased_date_day: ceasedDate === null || ceasedDate === void 0 ? void 0 : ceasedDate.day, ceased_date_month: ceasedDate === null || ceasedDate === void 0 ? void 0 : ceasedDate.month, ceased_date_year: ceasedDate === null || ceasedDate === void 0 ? void 0 : ceasedDate.year, start_date_day: startDate === null || startDate === void 0 ? void 0 : startDate.day, start_date_month: startDate === null || startDate === void 0 ? void 0 : startDate.month, start_date_year: startDate === null || startDate === void 0 ? void 0 : startDate.year });
        })
    };
};
const mapToTrustToReview = (trust) => {
    return Object.assign(Object.assign({}, mapToTrust(trust)), { review_status: trust.review_status });
};
/**
 ...
 */
const mapTrustsToReview = (trusts = []) => {
    return trusts.map(trust => mapTrustToReview(trust));
};
const mapTrust = (trust) => {
    const { creation_date_day, creation_date_month, creation_date_year, ceased_date_day, ceased_date_month, ceased_date_year, INDIVIDUALS, HISTORICAL_BO, CORPORATES, unable_to_obtain_all_trust_info, trust_still_involved_in_overseas_entity } = trust, rest = __rest(trust, ["creation_date_day", "creation_date_month", "creation_date_year", "ceased_date_day", "ceased_date_month", "ceased_date_year", "INDIVIDUALS", "HISTORICAL_BO", "CORPORATES", "unable_to_obtain_all_trust_info", "trust_still_involved_in_overseas_entity"]);
    ...
    return Object.assign(Object.assign({}, rest), { creation_date: convertOptionalDateToIsoDateString(creation_date_day, creation_date_month, creation_date_year), ceased_date: convertOptionalDateToIsoDateString(ceased_date_day, ceased_date_month, ceased_date_year), INDIVIDUAL: mapTrustIndividuals(INDIVIDUALS), HISTORICAL_BO: mapTrustHistoricalBeneficialOwners(HISTORICAL_BO), CORPORATE: mapTrustCorporates(CORPORATES), trust_still_involved_in_overseas_entity: stillInvolved, unable_to_obtain_all_trust_info: (unable_to_obtain_all_trust_info === "Yes") });
};
const mapTrustToReview = (trust) => {
    return Object.assign(Object.assign({}, mapTrust(trust)), { review_status: trust.review_status });
};
/**
...
const mapTrustIndividuals = (trustIndividuals = []) => {
    return trustIndividuals.map(trustIndividual => {
        const { dob_day, dob_month, dob_year, date_became_interested_person_day, date_became_interested_person_month, date_became_interested_person_year, still_involved, ceased_date_day, ceased_date_month, ceased_date_year, start_date_day, start_date_month, start_date_year } = trustIndividual, rest = __rest(trustIndividual, ["dob_day", "dob_month", "dob_year", "date_became_interested_person_day", "date_became_interested_person_month", "date_became_interested_person_year", "still_involved", "ceased_date_day", "ceased_date_month", "ceased_date_year", "start_date_day", "start_date_month", "start_date_year"]);
        ...
        return Object.assign(Object.assign({}, rest), { date_of_birth: convertOptionalDateToIsoDateString(dob_day, dob_month, dob_year), date_became_interested_person: convertOptionalDateToIsoDateString(date_became_interested_person_day, date_became_interested_person_month, date_became_interested_person_year), is_individual_still_involved_in_trust: isStillInvolved, ceased_date: convertOptionalDateToIsoDateString(ceased_date_day, ceased_date_month, ceased_date_year), start_date: convertOptionalDateToIsoDateString(start_date_day, start_date_month, start_date_year) });
    });
};
/**
...
const mapTrustCorporates = (trustCorporates = []) => {
    return trustCorporates.map(trustCorporate => {
        const { date_became_interested_person_day, date_became_interested_person_month, date_became_interested_person_year, still_involved, ceased_date_day, ceased_date_month, ceased_date_year, start_date_day, start_date_month, start_date_year } = trustCorporate, rest = __rest(trustCorporate, ["date_became_interested_person_day", "date_became_interested_person_month", "date_became_interested_person_year", "still_involved", "ceased_date_day", "ceased_date_month", "ceased_date_year", "start_date_day", "start_date_month", "start_date_year"]);
        return Object.assign(Object.assign({}, rest), { date_became_interested_person: convertOptionalDateToIsoDateString(date_became_interested_person_day, date_became_interested_person_month, date_became_interested_person_year), is_corporate_still_involved_in_trust: still_involved ? (still_involved === "Yes") : null, ceased_date: convertOptionalDateToIsoDateString(ceased_date_day, ceased_date_month, ceased_date_year), start_date: convertOptionalDateToIsoDateString(start_date_day, start_date_month, start_date_year) });
    });
};
...
const mapRemoveResource = (removeResource) => {
...
const mapHasSoldLand = (option) => {
    return typeof option === "undefined" ? option : (option !== "0");
};
const mapHasSoldLandResource = (option) => {
    return typeof option !== "boolean" ? undefined : (option ? "1" : "0");
};
const mapIsSecureRegister = (option) => {
    return typeof option === "undefined" ? option : (option !== "0");
};
const mapIsSecureRegisterResource = (option) => {
    return typeof option !== "boolean" ? undefined : (option ? "1" : "0");
};
