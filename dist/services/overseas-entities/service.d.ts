...
export default class OverseasEntityService {
    ...
    getOverseasEntity(transactionId: string, overseasEntityId: string, forceFetch?: boolean): Promise<Resource<OverseasEntity> | ApiErrorResponse>;
    ...
    putOverseasEntity(transactionId: string, overseasEntityId: string, body: OverseasEntity, forceUpdate?: boolean): Promise<Resource<HttpStatusCode> | ApiErrorResponse>;
    /**
