...
export declare enum NatureOfControlJurisdictionType {
    ENGLAND_AND_WALES = "ENGLAND_AND_WALES",
    SCOTLAND = "SCOTLAND",
    NORTHERN_IRELAND = "NORTHERN_IRELAND"
}
export declare enum ChangeBoRelevantPeriodType {
    YES = "CHANGE_BO_RELEVANT_PERIOD",
    NO = "NO_CHANGE_BO_RELEVANT_PERIOD"
}
export declare enum TrusteeInvolvedRelevantPeriodType {
    YES = "TRUSTEE_INVOLVED_RELEVANT_PERIOD",
    NO = "NO_TRUSTEE_INVOLVED_RELEVANT_PERIOD"
}
export declare enum ChangeBeneficiaryRelevantPeriodType {
