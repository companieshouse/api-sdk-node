...
exports.Term = exports.Jurisdiction = exports.PartnershipType = exports.NameEndingType = exports.PartnershipKind = exports.PartnerKind = exports.IncorporationKind = exports.NaturesOfControl = void 0;
var NaturesOfControl;
(function (NaturesOfControl) {
    NaturesOfControl["INDIVIDUAL"] = "Nature of control for this individual";
    NaturesOfControl["INDIVIDUAL_FIRM_CONTROL"] = "Nature of control by a firm over which this individual has significant control";
    NaturesOfControl["INDIVIDUAL_TRUST_CONTROL"] = "Nature of control by a trust over which this individual has significant control";
    NaturesOfControl["RLE"] = "Nature of control for this relevant legal entity (RLE)";
    NaturesOfControl["RLE_FIRM_CONTROL"] = "Nature of control by a firm over which the RLE has significant control";
    NaturesOfControl["RLE_TRUST_CONTROL"] = "Nature of control by a trust over which the RLE has significant control";
    NaturesOfControl["ORP"] = "Nature of control for this other registrable person (ORP)";
    NaturesOfControl["ORP_FIRM_CONTROL"] = "Nature of control by a firm over which the ORP has significant control";
    NaturesOfControl["ORP_TRUST_CONTROL"] = "Nature of control by a trust over which the ORP has significant control";
})(NaturesOfControl = exports.NaturesOfControl || (exports.NaturesOfControl = {}));
...
(function (PartnerKind) {
    ...
    PartnerKind["UPDATE_GENERAL_PARTNER_PERSON"] = "limited-partnership#update-general-partner-person";
    PartnerKind["UPDATE_GENERAL_PARTNER_LEGAL_ENTITY"] = "limited-partnership#update-general-partner-legal-entity";
    PartnerKind["UPDATE_LIMITED_PARTNER_PERSON"] = "limited-partnership#update-limited-partner-person";
    PartnerKind["UPDATE_LIMITED_PARTNER_LEGAL_ENTITY"] = "limited-partnership#update-limited-partner-legal-entity";
...
(function (PartnershipKind) {
    ...
    PartnershipKind["UPDATE_PARTNERSHIP_REDESIGNATE_TO_PFLP"] = "limited-partnership#update-partnership-redesignate-to-pflp";
