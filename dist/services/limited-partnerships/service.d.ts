...
import { Incorporation, LimitedPartnership, LimitedPartnershipResourceCreated, LimitedPartnershipIncorporation, GeneralPartner, LimitedPartner, PersonWithSignificantControl } from "./types";
...
export default class LimitedPartnershipsService {
    ...
    postPsc(transactionId: string, body: PersonWithSignificantControl): Promise<Resource<LimitedPartnershipResourceCreated> | ApiErrorResponse>;
    getPsc(transactionId: string, pscId: string): Promise<Resource<PersonWithSignificantControl> | ApiErrorResponse>;
    patchPsc(transactionId: string, pscId: string, body: PersonWithSignificantControl["data"]): Promise<Resource<void> | ApiErrorResponse>;
}
