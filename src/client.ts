...
import { Directors as DirectorsService } from "./services/directors";
/**
...
export default class ApiClient {
    ...
    public readonly directors: DirectorsService;
    ...
    constructor (
        ...
        this.confirmationStatementService = new ConfirmationStatementService(
            apiClient
        );
        ...
        this.pscDiscrepancyReport = new PSCDiscrepanciesReportService(
            apiClient
        );
        this.transaction = new TransactionService(apiClient);
        this.directors = new DirectorsService(apiClient);
    }
}
