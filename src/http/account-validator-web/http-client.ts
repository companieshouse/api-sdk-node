...
export default interface IHttpClient2 {
  ...
  httpGetBinary(url: string, headers?: Headers): Promise<HttpResponse>;
...
export abstract class AbstractClient implements IHttpClient2 {
  ...
  public abstract httpGetBinary(url: string, headers?: Headers): Promise<HttpResponse>;
